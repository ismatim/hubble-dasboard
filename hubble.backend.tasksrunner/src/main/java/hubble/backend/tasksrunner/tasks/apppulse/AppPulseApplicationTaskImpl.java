...
public class AppPulseApplicationTaskImpl implements ParserTask {
    ...
    public AppPulseApplicationTaskImpl() {

    }

    public AppPulseApplicationTaskImpl(ParserJob providerJob) {
