...
public class GetDataLocalServiceLocator extends org.apache.axis.client.Service implements org.apache.axis.GetDataLocalService {
    ...
    public org.apache.axis.GetDataLocal getGdeWsOpenAPI() throws javax.xml.rpc.ServiceException {
    ...
    public org.apache.axis.GetDataLocal getGdeWsOpenAPI(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.apache.axis.GdeWsOpenAPISoapBindingStub _stub = new org.apache.axis.GdeWsOpenAPISoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.apache.axis.GetDataLocal.class.isAssignableFrom(serviceEndpointInterface)) {
                org.apache.axis.GdeWsOpenAPISoapBindingStub _stub = new org.apache.axis.GdeWsOpenAPISoapBindingStub(new java.net.URL(GdeWsOpenAPI_address), this);
                _stub.setPortName(getGdeWsOpenAPIWSDDServiceName());
                return _stub;
            }
        }
