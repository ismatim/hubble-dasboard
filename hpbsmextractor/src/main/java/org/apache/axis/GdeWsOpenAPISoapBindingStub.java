/**
 * GdeWsOpenAPISoapBindingStub.java
 *
...
public class GdeWsOpenAPISoapBindingStub extends org.apache.axis.client.Stub implements org.apache.axis.GetDataLocal {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setName("getDataWebService");
        ...
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "origRowCount"), org.apache.axis.description.ParameterDesc.OUT, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"), int.class, false, false);
        oper.addParameter(param);
    ...
    public GdeWsOpenAPISoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public GdeWsOpenAPISoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public GdeWsOpenAPISoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {user, password, query});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                origRowCount.value = ((java.lang.Integer) _output.get(new javax.xml.namespace.QName("", "origRowCount"))).intValue();
            } catch (java.lang.Exception _exception) {
                origRowCount.value = ((java.lang.Integer) org.apache.axis.utils.JavaUtils.convert(_output.get(new javax.xml.namespace.QName("", "origRowCount")), int.class)).intValue();
            }
            try {
