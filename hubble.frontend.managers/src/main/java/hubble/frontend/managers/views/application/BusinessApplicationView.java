package hubble.frontend.managers.views.application;
...
public class BusinessApplicationView {
    ...
    private Integer availabilityAverage10min;
    private Integer performanceAverage10min;
    private Integer measuresQtyAvailability10min;
    private Integer measuresQtyPerformance10min;
    private Integer availabilityAverage1hour;
    private Integer performanceAverage1hour;
    private Integer measuresQtyAvailability1hour;
    private Integer measuresQtyPerformance1hour;
    private Integer availabilityAverage1day;
    private Integer performanceAverage1day;
    private Integer measuresQtyAvailability1day;
    private Integer measuresQtyPerformance1day;
    private Integer availabilityCriticalValue10min;
    private Integer performanceCriticalValue10min;
    private Integer availabilityCriticalValue1hour;
    private Integer performanceCriticalValue1hour;
    private Integer availabilityCriticalValue1day;
    private Integer performanceCriticalValue1day;
    ...
    public Integer getAvailabilityAverage10min() {
        return availabilityAverage10min;
    }

    public void setAvailabilityAverage10min(Integer availabilityAverage) {
        this.availabilityAverage10min = availabilityAverage;
    }

    public Integer getPerformanceAverage10min() {
        return performanceAverage10min;
    }

    public void setPerformanceAverage10min(Integer performanceAverage) {
    ...
    public void setAvailabilityAverage1hour(Integer availabilityAverage1hour) {
        this.availabilityAverage1hour = availabilityAverage1hour;
    }

    public Integer getPerformanceAverage1hour() {
        return performanceAverage1hour;
    }

    public void setPerformanceAverage1hour(Integer performanceAverage1hour) {
    ...
    public Integer getAvailabilityAverage1day() {
        return availabilityAverage1day;
    }

    public void setAvailabilityAverage1day(Integer availabilityAverage1day) {
        this.availabilityAverage1day = availabilityAverage1day;
    }

    public Integer getPerformanceAverage1day() {
        return performanceAverage1day;
    }

    public void setPerformanceAverage1day(Integer performanceAverage1day) {
    ...
    public Integer getAvailabilityAverage1hour() {
        return availabilityAverage1hour;
    }

    public Integer getAvailabilityCriticalValue10min() {
        return availabilityCriticalValue10min;
    }

    public void setAvailabilityCriticalValue10min(Integer availabilityCriticalValue10min) {
        this.availabilityCriticalValue10min = availabilityCriticalValue10min;
    }

    public Integer getPerformanceCriticalValue10min() {
        return performanceCriticalValue10min;
    }

    public void setPerformanceCriticalValue10min(Integer performanceCriticalValue10min) {
        this.performanceCriticalValue10min = performanceCriticalValue10min;
    }

    public Integer getAvailabilityCriticalValue1hour() {
        return availabilityCriticalValue1hour;
    }

    public void setAvailabilityCriticalValue1hour(Integer availabilityCriticalValue1hour) {
        this.availabilityCriticalValue1hour = availabilityCriticalValue1hour;
    }

    public Integer getPerformanceCriticalValue1hour() {
        return performanceCriticalValue1hour;
    }

    public void setPerformanceCriticalValue1hour(Integer performanceCriticalValue1hour) {
        this.performanceCriticalValue1hour = performanceCriticalValue1hour;
    }

    public Integer getAvailabilityCriticalValue1day() {
        return availabilityCriticalValue1day;
    }

    public void setAvailabilityCriticalValue1day(Integer availabilityCriticalValue1day) {
        this.availabilityCriticalValue1day = availabilityCriticalValue1day;
    }

    public Integer getPerformanceCriticalValue1day() {
        return performanceCriticalValue1day;
    }

    public void setPerformanceCriticalValue1day(Integer performanceCriticalValue1day) {
