...
public class MapperConfigurationUnitTests {
    ...
    public void mapper_configuration_should_map_availabilityApplicationAvgDto_to_AvailabilityBusinessApplicationAvg() {
        ...
        when(availabilityAvgDto.getAvailabilityThreshold()).thenReturn(90f);
        when(availabilityAvgDto.getAvailabilityAverageValue()).thenReturn(7510f);
        when(availabilityAvgDto.getCriticalThreshold()).thenReturn(12000f);
        when(availabilityAvgDto.getOkThreshold()).thenReturn(8000f);
        when(availabilityAvgDto.getOutlierThreshold()).thenReturn(45000f);
        ...
        assertEquals(90f, availabilityApplicationAvg.getBusinessApplication().getAvailabilityThreshold(), 0);
